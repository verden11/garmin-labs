...
- Repo: private GitHub `verden11/garmin-labs`, branch `main` — monorepo; this site is the `verden-site/` folder. Netlify **base directory** must stay `verden-site` (that is how `netlify.toml` get found).
