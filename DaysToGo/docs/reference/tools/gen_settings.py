...
Writes, relative to the project root:
  ...
  resources/strings/generated.xml     the numbers-only strings (not translated)
...
MONTHS = 12
ACCENTS = ["gold", "blue", "green", "pink", "cyan", "white"]
...
PROPS = [("Event", 0, "number"), ("Name", "", "string"), ("Month", 1, "number"), ("Day", 1, "number"),
         ("Year", 0, "number"), ("Hour", 0, "number"), ("Unit", 0, "number"), ("Footer", 0, "number"),
         ("Accent", 0, "number")]
...
def hand_ids():
    ids = ["setting_event", "event_new_year", "event_christmas", "event_custom", "setting_name",
           ...
           "setting_unit", "unit_days", "unit_weeks", "setting_footer", "footer_none", "footer_battery",
