...
function complicationValueReportsProgressIntoTheRank(logger as Test.Logger) as Lang.Boolean {
    ...
    var state = new HeroSetDashboardState(0, 0, 0, xp, rank, 0, false);
    ...
    Test.assertEqual(value, "1|20260920|0|0|0|3|50|0|20260901");
    return true;
}
