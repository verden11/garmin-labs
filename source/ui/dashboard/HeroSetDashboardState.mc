...
class HeroSetDashboardState {
    ...
    function initialize(pushups as Lang.Number, situps as Lang.Number, squats as Lang.Number, rank as Lang.Number, streak as Lang.Number, storageWarning as Lang.Boolean) {
