...
Button-first daily push-ups, sit-ups, squats app for 67 round five-button Garmin watches. Automatic rep counting that learns from the counts you save, count adjustable before save, daily goals, XP, rank, streaks, live HR and calorie estimate. Everything stays on the watch: no activity recorded, nothing synced. Counting depends on placement and movement, so it can be off.
