...
| UTM links, tracked outbound click, landing to store handoff >=10% gate | `verden-site` promises **zero client JS, no analytics, Netlify Analytics off, privacy page says none**. UTMs alone measure nothing | **CONFLICT** |
