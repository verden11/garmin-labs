...
| D3 | HSTS + Permissions-Policy | DONE, IB body wrong on values | `verden-site/firebase.json`: `max-age=31536000` (no `includeSubDomains`); IB body still says `63072000; includeSubDomains`. Preface is right. Permissions-Policy present as described. |
